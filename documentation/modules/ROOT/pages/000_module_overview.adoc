...
====
*001 - A High Level Introduction to Azure Red Hat Openshift*

This Module will give you an overview of what ARO actually is, and how it works.
...
====
*002 - Deploying an Application to ARO*

This Module will introduce you to the concepts of *Applications* from the perspective of deploying them on ARO. 
